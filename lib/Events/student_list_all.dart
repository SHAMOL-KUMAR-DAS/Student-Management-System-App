...
class Student_All extends StatefulWidget {
  String userUid, userEmail;
  Student_All(this.userUid, this.userEmail);
  @override
  _Student_AllState createState() => _Student_AllState();
}
class _Student_AllState extends State<Student_All> {
