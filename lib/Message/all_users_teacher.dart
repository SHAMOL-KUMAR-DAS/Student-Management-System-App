...
import 'package:school_management/Message/studentList_teacher.dart';
...
class All_Users_Teacher extends StatefulWidget {
  String type, image;
  All_Users_Teacher(this.type, this.image);
  @override
  _All_Users_TeacherState createState() => _All_Users_TeacherState();
}

class _All_Users_TeacherState extends State<All_Users_Teacher> {
  FirebaseUser user;
          ...
          Row(
            children: [
              ...
              Expanded(
                child: FlatButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>StudentList_Teacher(widget.type, widget.image)));
                    //Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>StudentList_Teacher(widget.type, widget.image)), (route) => false);
                  },
                  child: Text('Student'),
                ),
              ),
