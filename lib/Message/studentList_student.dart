...
class StudentList_Student extends StatefulWidget {
  String type, image, clas;
  StudentList_Student(this.type, this.image, this.clas);
  @override
  _StudentList_StudentState createState() => _StudentList_StudentState();
}

class _StudentList_StudentState extends State<StudentList_Student> {
  FirebaseUser user;
          ...
          Row(
            children: [
              Expanded(
                child: FlatButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>All_Users_Student(widget.type, widget.image, widget.clas)));
                  },
                  child: Text('All'),
                ),
              ),
