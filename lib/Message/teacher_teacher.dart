...
import 'all_user_student.dart';
import 'chat_page.dart';

class Teacher_Teacher extends StatefulWidget {
  String type, image, clas;
  Teacher_Teacher(this.type, this.image, this.clas);
  @override
  _Teacher_TeacherState createState() => _Teacher_TeacherState();
}

class _Teacher_TeacherState extends State<Teacher_Teacher> {
  FirebaseUser user;
